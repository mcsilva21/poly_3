...
public class Item {
	...
	public String toString() {
		return clgcpDivCd+","+clgcpDivNm+","+estbDivCd+","+estbDivNm+","+schlDivCd+","+ schlDivNm+","+schlFullNm
				+","+schlId+","+schlKndCd+","+schlKndNm+","+schlKrnNm+","+svyYr+","+znCd+","+znNm;
	}
	public String toSQL() {
	      return "INSERT INTO academy VALUES ("
	            + "'" + clgcpDivCd + "','" + clgcpDivNm + "'," + estbDivCd + ",'" + estbDivNm + "','" + schlDivCd + "','" + 
	            schlDivNm + "','" + schlFullNm + "','" + schlId + "','" + schlKndCd + "','" + schlKndNm + "','" + 
	            schlKrnNm + "'," + svyYr + "," + znCd + ",'" + znNm
	            + "');";
	   }
