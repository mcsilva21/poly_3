			...
			<tbody>
				...
				<c:forEach var="item" items="${list}">
					<tr>
						...
						<td>${item.answer3}</td>
						<td>${item.answer4}</td>
						<td><a href="${item.quizId}/delete">삭제</a><br><a href="${item.quizId}/update">변경</a></td>
					</tr>
				</c:forEach>
...
<div>
    ...
    <li class="page-item"><a class="page-link" href="http://localhost:8011/q/list?page=1&">1</a></li>
    <li class="page-item"><a class="page-link" href="http://localhost:8011/q/list?page=2&">2</a></li>
    <li class="page-item"><a class="page-link" href="http://localhost:8011/q/list?page=3&">3</a></li>
