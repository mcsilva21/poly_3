...
<title>Hassue - member register</title>
				...
				<div class="container">
					<div class="text-center">
						<h2 class="section-heading text-uppercase">Hassue에 오신 것을
							환영합니다!</h2>
						<p class="section-subheading text-muted">Hassue에 가입하셔서 더 많은
							서비스를 누리세요!
						</h3>
					</div>

					</br> </br> </br> </br> <span><div class="text-center">
							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type="text"
								id="userId" name="userId" placeholder="YOUR ID">
